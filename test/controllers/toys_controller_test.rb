...
class ToysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create toy" do
    assert_difference('Toy.count') do
      post toys_url, params: { toy: { description: @toy.description, image: @toy.image, land: @toy.land, name: @toy.name, title: @toy.title } }
    end
  ...
  test "should update toy" do
    patch toy_url(@toy), params: { toy: { description: @toy.description, image: @toy.image, land: @toy.land, name: @toy.name, title: @toy.title } }
